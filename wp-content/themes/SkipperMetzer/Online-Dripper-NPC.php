<?php
/*
Template Name: Online Dripper NPC
*/
?>
<!doctype html>
<html lang="en">
...
<body>
    <div class="wrapper">
        ...
        <main>
            <section class="topBannerProducts" style="background: url('/wp-content/themes/SkipperMetzer/Images/Gallery/sheluchot_palm_tree_adi.jpg')no-repeat bottom 33% right;background-size: cover;align-items: flex-start;">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <nav class="nav flex-column card sideNavBar">
                                ...
                                <li class="nav-item dropdown ">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="nav-link active" href="/online-dripper-npc">Online Dripper (Non PC)</a></li>
                                        <li><a class="nav-link" href="/online-dripper-pc-gali">Online Dripper (PC Gali)</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="btn downloadBtn mt-4" href="/wp-content/themes/SkipperMetzer/Pdfs/Technical-data-Npc.pdf" download="Non PC Technical PDF">Download Technical Detail PDF</a>
                            <div class="card text-center align-items-center justify-content-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/ProductImages/Online_Dripper_4/online-drippers.png" alt="Online Dripper NPC" class="img-fluid w-100 imgSec">
                            </div>
                            <div class="card text-center align-items-center justify-content-center mt-4">
