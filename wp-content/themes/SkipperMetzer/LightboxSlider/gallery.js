      ...
      // Check if preview Image exsits
         x = AjaxCall(obj,i);
          if(x==1){
            ...
            $('.Gallery').append('<div class="col-md-3 mt-3"><img loading="lazy" class="'+className+'" alt="Image'+ImageIndex+'" width="100%" height="100%" class="fadein" id="'+ImageIndex+'" onClick="openViewer(this.id)" src="'+newURL+'"/></div>');   
            ImageIndex++;
          }
     }
});
