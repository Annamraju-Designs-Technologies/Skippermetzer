<?php
/*
Template Name:  LIN Light Flat Integral Dripper
*/
?>
<!doctype html>
<html lang="en">
...
<body>
    <div class="wrapper">
        ...
        <main>
            <section class="topBannerProducts" style="background: url('/wp-content/themes/SkipperMetzer/Images/Banner-photos/LINBanner.jpg')no-repeat bottom;background-size: cover;align-items: flex-start;">
                    ...
                    <div class="row">
                        <!-- <div class="col-md-3">
                            <nav class="nav flex-column card sideNavBar">
                                ...
                                <a class="nav-link active" aria-current="page" href="/lin-light-flat-integral-dripper">LIN Dripline</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <a class="btn downloadBtn mt-4" href="/wp-content/themes/SkipperMetzer/Pdfs/Technical-data-Lin-Dripline .pdf" download="LIN Dripline Flyer Technical PDF">Download Technical Detail PDF</a>
                        </div>
                        <div class="col-md-6">
                            <div class="card text-center align-items-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/ProductImages/Lin_Dripline_1/Lin_Breakdown_1.png" alt="LIN" class="img-fluid w-100 imgSec">
                            </div>
                            <div class="card text-center align-items-center mt-4">
                            ...
                            <div class="card text-center align-items-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/ProductImages/Lin_Dripline_1/LIN-Flat-Drip-laterals.jpg" alt="LIN" class="img-fluid w-100 imgSec">
                            </div>
                        </div>
                        <div class="col-md-6 ">
                            <div class="specificDes mt-4 ps-5">
                                <p>Applications</p>
                                <ul>
                                    <li> Row Crops</li>
                                    <li> Vegetables</li>
