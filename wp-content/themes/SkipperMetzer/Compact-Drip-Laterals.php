<?php
/*
Template Name:  Compact Drip Laterals
*/
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <nav class="nav flex-column card sideNavBar">
                                ...
                                <a class="nav-link" aria-current="page" href="/lin-light-flat-integral-dripper">LIN Integral Dripper</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="#">Online Dripper (Non PC)</a></li>
                                        <li><a class="dropdown-item" href="#">Online Dripper (PC Gali)</a></li>
                                    </ul>
                                </li>
                                <a class="nav-link " href="#">HDP Pipes for Sprinkler Irrigation</a>
                                <a class="nav-link " href="#">Mini Sprinkler System</a>
                                <a class="nav-link " href="#">Verdit PC Integral Dripline</a>
                            </nav>
                        </div>
                        <div class="col-md-5">
                            <h2> Compact Drip Laterals</h2>
                            ...
                            <div class="card text-center align-items-center justify-content-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/Products/Compact-Drip-Laterals.jpg" alt="Compact-Drip-Laterals" class="img-fluid w-100 imgSec">
                            </div>
                        </div>
                        <div class="col-md-4 mt-5">
                            <div class="specificDes mt-5">
                                <p>Applications</p>
                                <ul>
                                    <li> Greenhouses</li>
                                    <li> Orchards</li>
                                ...
                                <p>Technical data</p>
                                <ul>
                                    <li> Dripper flow rates: 1.6 / 2.2 / 3.51/h</li>
                                    <li> Dripline diameters: 16 / 20 mm</li>
                                    <li> Dripline wall thickness: 0.9 - 1.25 mm</li>
                                </ul>
                                <p>Features</p>
                                <ul>
                                    <li> The ultimate cylindrical PC dripper for agriculture</li>
                                    <li> Everlasting reliability</li>
                                    <li> Unique and accurate pressure-compensating labyrinth mechanism</li>
                                    <li> Wide water passages with turbulent flow pattern</li>
                                    <li> Large Inlet filter area - up to 10 times larger than any other dripper</li>
                                    <li> Dual inlet filter for various sources</li>
                                    <li> Excellent for effluent reuse</li>
                                    <li> Highly clog-resistant</li>
                                    <li> Wide compensation range - up to 4.3 bar</li>
                                </ul>
                            </div>
                        </div>
                    </div>
