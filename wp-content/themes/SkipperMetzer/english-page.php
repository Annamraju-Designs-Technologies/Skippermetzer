<?php
/*
Template Name: Broucher English Page 
*/
?>
...
<head>
    ...
    <script src="/wp-content/themes/SkipperMetzer/LightboxSlider/brouchers.js"></script>
...
<body>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                    <div class="navbar-nav ms-auto text-uppercase">
                                        ...
                                        <a class="nav-link" href="#">Toll Free: 1800 572 2997</a>
                                    </div>
                                </div>
                            </div>
                        </nav>
        ...
        <main>
            <section class="topBanner">
                <div class="center-items">
                    <h1 class="mt-2 text-uppercase p-5 text-white">Brouchers</h1>
                </div>
            </section>
            <section class="">
                <div class="container-fluid">
    ...
    <script>
        ...
        //enableAutoWidth();
        json = '{ "Entry": { "Title": "", ' +
            '"Image": ["/wp-content/themes/SkipperMetzer/Pdfs/LIN_Flyer.pdf",' +
            '"/wp-content/themes/SkipperMetzer/Pdfs/ONLINE_DRIPPERS_Flyer_15Ver_CC.pdf",' +
            '"/wp-content/themes/SkipperMetzer/Pdfs/Super_Compact_Flyer.pdf",' +
            '"/wp-content/themes/SkipperMetzer/Pdfs/Skipper-Metzer-Broucher-4pgs-FINAL_15ver_CC.pdf" ] } }';
        addGallery(json);
    </script>
    <script type="text/javascript">
        var _gaq = _gaq || [];
