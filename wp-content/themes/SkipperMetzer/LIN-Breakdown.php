                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card text-center align-items-center justify-content-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/Products/Lin_Breakdown.png" alt="LIN" class="img-fluid w-100 imgSec">
                            </div>
                        </div>
                        <div class="col-md-4 mt-5">
                            <div class="specificDes mt-5">
                                ...
                                <p>Technical data</p>
                                <ul>
                                    <li> Dripper flow rate: 2.0 & 4.0 l/h</li>
                                    <li> Dripper diameters: 12 & 16mm</li>
                                    <li> Dripline wall thickens: 0.20-1.2mm</li>
                                </ul>
                                <p>Features</p>
                                <ul>
                                    <li> Inlet filter for clog resistance</li>
                                    <li> As per IS-13488</li>
                                    <li> Also available in low wall thicknesses</li>
                                    <li> Suitable for wide range of soil and crops</li>
                                </ul>
                            </div>
                        </div>
                    </div>
