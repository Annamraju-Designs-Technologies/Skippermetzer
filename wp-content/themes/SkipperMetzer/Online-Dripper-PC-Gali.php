<?php
/*
Template Name: Online Dripper PC Gali
*/
?>
<!doctype html>
<html lang="en">
...
<body>
    <div class="wrapper">
        ...
        <main>
            <section class="topBannerProducts" style="background: url('/wp-content/themes/SkipperMetzer/Images/Banner-photos/gali.jpg')no-repeat  top;background-size: cover;align-items: flex-start;">
                ...
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <nav class="nav flex-column card sideNavBar">
                                ...
                                <li class="nav-item dropdown ">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="nav-link " href="/online-dripper-npc">Online Dripper (Non PC)</a></li>
                                        <li><a class="nav-link active" href="/online-dripper-pc-gali">Online Dripper (PC Gali)</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card text-center align-items-center justify-content-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/ProductImages/PC_Gali_Dripper_5/Gali dripper with pipe.png" alt="Online Dripper PC Gali" class="img-fluid w-100 imgSec">
                            </div>
                        </div>
                        <div class="col-md-6 mt-5">
                            <div class="specificDes mt-5 ps-5">
                                ...
                                <p>Technical data</p>
                                <ul>
                                    <li> Dripper flow rates: 1.0, 2.0, 4.0 and 8.5 l/h</li>
                                    <li> Suitable for 12 / 16 / 20 mm Laterals</li>
                                    <li> Non-Drain option</li>
                                    <li> Color Coded</li>
                                </ul>
                                <p>Features</p>
                                <ul>
