<?php
/*
Template Name: Verdit PC Integral Dripline
*/
?>
<!doctype html>
<html lang="en">
...
<body>
    <div class="wrapper">
        ...
        <main>
            <section class="topBannerProducts" style="background: url('/wp-content/themes/SkipperMetzer/Images/Banner-photos/Verdict-banner.jpg')no-repeat bottom right;background-size: cover;align-items: flex-start;">
                    ...
                    <div class="row">
                        <!-- <div class="col-md-3">
                            <nav class="nav flex-column card sideNavBar">
                                ...
                                <a class="nav-link active" href="/verdit-pc-integral-dripline">Verdit PC Integral Dripline</a>
                                <li class="nav-item dropdown">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card text-center align-items-center justify-content-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/ProductImages/Verdit_3/verdit-PC-dripper.png" alt="Compact Integral Dripline" class="img-fluid w-100 imgSec">
                            </div>
                            <div class="card text-center align-items-center justify-content-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/ProductImages/Verdit_3/verdict-pc-dripper-with-lateral.jpg" alt="Compact Integral Dripline" class="img-fluid w-100 imgSec">
                            </div>
                            <div class="card text-center align-items-center justify-content-center mt-4">
                        ...
                        <div class="col-md-6 mt-5">
                            <div class="specificDes mt-5 ps-5">
                                ...
                                <ul>
                                    ...
                                    <li> Suitable for different water sources</li>
