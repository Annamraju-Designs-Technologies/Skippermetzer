                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <nav class="nav flex-column card sideNavBar">
                                ...
                                <a class="nav-link" href="#">Compact Integral Dripline</a>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card text-center align-items-center justify-content-center mt-4">
                                <img src="/wp-content/themes/SkipperMetzer/Images/Products/Asif.jpg" alt="LIN" class="img-fluid imgSec">
                            </div>
                        </div>
                        <div class="col-md-4 mt-5">
                            <div class="specificDes mt-5">
                                ...
                                <p>Technical data</p>
                                <ul>
                                    <li> Technical data Dripper flow rates: 0.85 / 1.2 / 1.6 / 2.1 / 3.4 I/h</li>
                                    <li> Dripline diameters: 16/ 20 / 25 mm</li>
                                    <li> Dripline wall thickness: 0.4 - 1.25 mm</li>
                                </ul>
                                <p>Features</p>
                                <ul>
                                    <li> Efficient and cost-effective flat dripper</li>
                                    <li> Wide range of working pressures for various topographies</li>
                                    <li> Uniform flow rate</li>
                                    <li> Expanded inlet filter</li>
                                    <li> Highly accurate pressure-compensating labyrinth mechanism</li>
                                    <li> Wide water passage along with the labryinth</li>
                                    <li> Suitable for different water sources</li>
                                    <li> Long lasting silicon diaphragm</li>
                                    <li> Durable under harsh field conditions & chemical applications</li>
                                </ul>
                            </div>
                        </div>
                    </div>
